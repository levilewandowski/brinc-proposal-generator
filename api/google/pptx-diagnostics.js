  ...
  try {
    ...
    var response = {
      ...
      validation: {
        ...
        relationshipsRenderCriticalList: (vRel.broken || []).filter(function(b) { return b.renderCritical; }).map(function(b) { return { typeShort: b.typeShort, target: b.target, resolved: b.resolved }; }),
        relationshipsBrokenFull: (vRel.broken || []).map(function(b) { return { typeShort: b.typeShort, type: b.type, rId: b.rId, target: b.target, resolved: b.resolved, sourcePart: b.sourcePart || b.relFile, renderCritical: b.renderCritical }; }),
